...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="hatcrab"
...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="43.852"
	TMUX_POWERLINE_SEG_AIR_LON="-79.008"
	# Your Open Weather API Key:
	TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY="9b139a37ce590771e69670382aea4c39"
# }
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_SERVER=""
	# How often in minutes to check for new mails.
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_INTERVAL="1"
	
	## Maildir
	# Path to the maildir to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/patrick.white/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/patrick.white/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/patrick.white/.now_playing.log"
...
# vcs_branch.sh {
	...
	export TMUX_POWERLINE_SEG_VCS_BRANCH_GIT_SYMBOL_COLOUR="140"
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="43.852"
	TMUX_POWERLINE_SEG_WEATHER_LON="-79.008"
# }
...
# figuring out the actual path to this file is too hard, and i always put it here anyway
if [ -e ~/.config/tmux-powerline/config.local.sh ]; then
    source ~/.config/tmux-powerline/config.local.sh
fi
